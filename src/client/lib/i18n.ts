...
const zh: Dict = {
  ...
  worktreesSubtitle: "扫描所有 Workspace 中的 Git 项目和 Worktree",
  repositories: "个项目",
  worktreeCount: "个 Worktree",
  refresh: "刷新",
  noWorktrees: "没有发现 Worktree。",
  noWorktreesHint: "会递归扫描所有 Workspace 下的 Git 项目。",
  branch: "分支",
  path: "路径",
  mainRepository: "主仓库",
...
const en: Dict = {
  ...
  worktreesSubtitle: "Scan every Workspace for Git projects and Worktrees",
  repositories: "repositories",
  worktreeCount: "Worktrees",
  refresh: "Refresh",
  noWorktrees: "No Worktrees found.",
  noWorktreesHint: "Every Workspace is scanned recursively for Git projects.",
  branch: "Branch",
  path: "Path",
